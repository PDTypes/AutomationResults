      ...
      (coe
         ...
         (coe
            ...
            (coe
               ...
               (coe
                  MAlonzo.Code.Data.Sum.Relation.Binary.Pointwise.du__'8846''8347'__524
                  (coe
                     MAlonzo.Code.Relation.Binary.PropositionalEquality.Properties.du_setoid_402)
                  (coe
                     MAlonzo.Code.Relation.Binary.PropositionalEquality.Properties.du_setoid_402))
               (coe
                  MAlonzo.Code.Data.Sum.Relation.Binary.Pointwise.du_Pointwise'45''8801''8596''8801'_590))))
      (coe
         MAlonzo.Code.Function.Equivalence.du__'8728'__82
         (coe
