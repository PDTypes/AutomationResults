...
data C : Set where
 satellite0 instrument0 image1 spectrograph2 thermograph0 star0 groundstation1 groundstation2 phenomenon3 phenomenon4 star5 phenomenon6 : C
-- EqC : Eq C
...
satelliteWDomain : Domain
satelliteWDomain = record
  { Predicate = R
  ; Action = Action
  ; Γ = Γ
  ; _≟ₚ_ = mangle }

open Domain satelliteWDomain  public
