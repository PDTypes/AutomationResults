...
data C : Set where
 apn1 apt3 pos3 apt2 pos2 apt1 pos1 cit3 cit2 cit1 tru3 tru2 tru1 obj33 obj32 obj31 obj23 obj22 obj21 obj13 obj12 obj11 : C
-- EqC : Eq C
...
logisticsW2Domain : Domain
logisticsW2Domain = record
  { Predicate = R
  ; Action = Action
  ; Γ = Γ
  ; _≟ₚ_ = mangle }

open Domain logisticsW2Domain  public
